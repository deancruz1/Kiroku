...
-- CreateIndex
CREATE UNIQUE INDEX "Review_entryId_key" ON "Review"("entryId");
...
-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_entryId_fkey" FOREIGN KEY ("entryId") REFERENCES "AnimeEntry"("id") ON DELETE CASCADE ON UPDATE CASCADE;
